...
const MediumClap = ({ children, onClap, values = null, style: userStyles = {}, className }) => {
  ...
  const handleClapClick = () => {
    ...
    isControlled
      ...
      : setClapState((prevState) => ({
          ...
          countTotal:
            prevState.count < MAXIMUM_USER_CLAP ? prevState.countTotal + 1 : prevState.countTotal,
          isClicked: true,
        }));
  };
  ...
  // const memoizedValue = useMemo(() => ({ ...getState(), setRef }), [clapState, values, setRef]);
...
const INITIAL_STATE = { count: 0, countTotal: 2100, isClicked: false };
